...
# threads. In our case, this is 2^16=65536 since n_particles/n_threads=53240.
# We run a simulation for every power of 2 in the range as well as the exact chunk size yielding
# one chunk per thread for n_particles (this corresponds to 53240 here).

# target folder
TARGET_FOLDER=Coral2_chunk_size/staticP2
...
mv tallies_report.csv $TARGET_FOLDER/tallies_C53240.csv
mv timers_report.csv $TARGET_FOLDER/timers_C53240.csv
