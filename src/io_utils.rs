...
pub struct Cli {
    ...
    #[arg(short='n', long="n-particles", num_args(1), allow_negative_numbers(false))]
    pub n_particles: Option<u64>,

    /// number of particles in a vault/batch
    #[arg(short='g', long="batch-size", num_args(1), allow_negative_numbers(false))]
    pub batch_size: Option<u64>,

    /// number of vault/batch to start; sets batch-size automatically if specified
    #[arg(short='b', long="n-batches", num_args(1), allow_negative_numbers(false))]
    pub n_batches: Option<u64>,

    /// number of steps simulated
    #[arg(short='N', long="n-steps", num_args(1), allow_negative_numbers(false))]
    ...
    */
    ...
    #[arg(short='B', long="b-tally", num_args(1), allow_negative_numbers(false))]
    pub b_tally: Option<u32>,

    /// number of scalar flux tally replications
    #[arg(short='F', long="f-tally", num_args(1), allow_negative_numbers(false))]
    pub f_tally: Option<u32>,

    /// number of scalar cell tally replications
    #[arg(short='C', long="c-tally", num_args(1), allow_negative_numbers(false))]
